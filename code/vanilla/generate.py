...
while True:
    ...
    # model.load_state_dict(torch.load(f'output2/kobart_epoch_{count}.pth'))
    model.load_state_dict(torch.load('output/kobart_best.pth'))
    model.model.eval()
    ...
    with open('output2/output_best.txt', 'w', encoding='utf-8') as f:
